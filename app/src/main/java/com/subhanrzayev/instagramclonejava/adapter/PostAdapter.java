package com.subhanrzayev.instagramclonejava.adapter;
...
import com.subhanrzayev.instagramclonejava.databinding.RecyclerRowBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        holder.recyclerRowBinding.recyclerViewEmailUserText.setText(postArrayList.get(position).email);
